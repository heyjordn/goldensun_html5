...
export function split_direction(direction: directions) {
  ...
  vals[0] =
    direction === directions.right ? directions.up_right : direction - 1;
  vals[1] =
    direction === directions.up_right ? directions.right : direction + 1;
  return vals;
}
 ...
 */
export function join_directions(
  dir_1: directions,
  dir_2: directions
): directions {
 ...
 */
export function get_transition_directions(
 ...
 */
export function get_vector_direction(
  x1: number,
  x2: number,
  y1: number,
  y2: number
...
export function get_text_width(
  ...
  const text_sprite = game.add.bitmapText(
    0,
    0,
    font_name,
    text,
 ...
 */
export function get_sqr_distance(
  x1: number,
  x2: number,
  y1: number,
  y2: number
 ...
 */
export function get_surroundings(
  x: number,
  y: number,
 ...
 */
export function mount_collision_polygon(
  width: number,
  shift: number,
  bevel: number = 0
) {
 ...
 */
export async function promised_wait(
  game: Phaser.Game,
  time: number,
  callback?: () => void
) {
