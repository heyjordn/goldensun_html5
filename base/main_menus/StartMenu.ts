...
export class StartMenu {
  ...
  private set_press_start_text() {
    ...
    const y_pos = 124;
    this.text_sprite_shadow = this.game.add.bitmapText(
      x_pos + 1,
      y_pos + 1,
      FONT_NAME,
      text,
    ...
    this.text_sprite = this.game.add.bitmapText(
      x_pos,
      y_pos,
      FONT_NAME,
      text,
  ...
  private set_press_start_tween() {
    ...
    this.text_shadow_tween = this.game.tweens
      .create(this.text_sprite_shadow)
      .to(
        {
          alpha: 0.1,
        },
  ...
  async init_bgm() {
    ...
    const promise = new Promise(
      (resolve) => (load_bgm_promise_resolve = resolve)
    );
    this.game.load
