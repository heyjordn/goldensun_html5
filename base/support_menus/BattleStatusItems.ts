...
export class BattleStatusItems extends StatusComponent {
  ...
  public select_option() {
    const highlight = {
      ...
      y:
        BattleStatusItems.HIGHLIGHT.Y +
        BattleStatusItems.SHIFT * this.current_line,
    ...
    const cursor_y =
      BattleStatusItems.CURSOR.Y + BattleStatusItems.SHIFT * this.current_line;
  ...
  public initialize() {
    ...
    items.forEach((item_slot, index) => {
      ...
      let y_pos =
        BattleStatusItems.ITEM.ICON_Y + index * BattleStatusItems.SHIFT;
