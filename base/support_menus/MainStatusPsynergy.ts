...
export class MainStatusPsynergy extends StatusComponent {
  ...
  public select_option() {
    const highlight = {
      ...
      y:
        MainStatusPsynergy.HIGHLIGHT.Y +
        MainStatusPsynergy.SHIFT * this.current_line,
  ...
  public on_change() {
    ...
    const chosen_ability =
      this.ability_pages[this.current_col][this.current_line];
    ...
    if (
      chosen_ability.is_field_psynergy ||
      chosen_ability.effects_outside_battle
    )
      use_text += "Towns";
  ...
  public initialize() {
    ...
    if (!this.ability_pages[this.current_col])
      this.current_col = this.ability_pages.length - 1;
    ...
    abilities.forEach((ability, index) => {
      ...
      let y_pos =
        MainStatusPsynergy.PSYNERGY.ICON_Y + index * MainStatusPsynergy.SHIFT;
      ...
      y_pos =
        MainStatusPsynergy.PSYNERGY.NAME_Y + index * MainStatusPsynergy.SHIFT;
      ...
      y_pos =
        MainStatusPsynergy.PSYNERGY.PP_VALUE_Y +
        index * MainStatusPsynergy.SHIFT;
      ...
      y_pos =
        MainStatusPsynergy.PSYNERGY.STAR_Y + index * MainStatusPsynergy.SHIFT;
      ...
      y_pos =
        MainStatusPsynergy.PSYNERGY.RANGE_Y + index * MainStatusPsynergy.SHIFT;
