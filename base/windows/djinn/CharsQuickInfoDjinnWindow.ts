...
export class CharsQuickInfoDjinnWindow {
  ...
  constructor(game) {
    ...
    this.char_class = this.base_window.set_text_in_position(
      "",
      NAME_X,
      CLASS_Y
    );
    this.level_label = this.base_window.set_text_in_position("Lv", LV_X, LV_Y);
    this.level_number = this.base_window.set_text_in_position(
      "",
      LV_NUMBER_RIGHT_X,
      LV_Y,
      { right_align: true }
    ...
    this.l_button = {
      ...
      main: this.base_window.create_at_group(
        L_BUTTON_X,
        L_BUTTON_Y,
        "keyboard_buttons",
        {
    ...
    this.current_status_label = this.base_window.set_text_in_position(
      "Current status",
      NAME_X,
      NAME_Y
    );
    this.current_status_label.text.visible =
      this.current_status_label.shadow.visible = false;
    this.a_button = {
      shadow: this.base_window.create_at_group(
        L_BUTTON_X + 1,
        L_BUTTON_Y + 1,
    ...
    this.return_label = this.base_window.set_text_in_position(
      ": Return",
      this.a_button.main.x +
        this.a_button.main.width +
        this.b_button.main.width +
        4,
  ...
  set_return_info_visibility(visible: boolean) {
    this.current_status_label.text.visible =
      this.current_status_label.shadow.visible = visible;
