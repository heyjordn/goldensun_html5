...
export class DjinnActionWindow {
  ...
  constructor(game: Phaser.Game) {
    ...
    this.action_description_text = this.base_window.set_text_in_position(
      "",
      CHOOSE_A_DJ_X,
      CHOOSE_A_DJ_Y
    );
    ...
    this.djinn_name_text = this.base_window.set_text_in_position(
      "",
      DJINN_NAME_X,
      DJINN_NAME_Y
    );
