...
export class StatsCheckWithItemWindow {
  ...
  constructor(game, data) {
    ...
    this.preview_stats_texts = {
      [effect_types.ATTACK]: this.base_window.set_text_in_position(
        "0",
        PREVIEW_TEXT_X,
        48,
        {
      ...
      [effect_types.DEFENSE]: this.base_window.set_text_in_position(
        "0",
        PREVIEW_TEXT_X,
        64,
        {
      ...
      [effect_types.AGILITY]: this.base_window.set_text_in_position(
        "0",
        PREVIEW_TEXT_X,
        80,
        {
    ...
    this.attack_text = this.base_window.set_text_in_position("0", 40, 48, {
      right_align: true,
    });
    this.defense_text = this.base_window.set_text_in_position("0", 40, 64, {
      right_align: true,
    });
    this.agility_text = this.base_window.set_text_in_position("0", 40, 80, {
      right_align: true,
    });
  }
  ...
  update_preview_text(value, effect_type) {
    ...
    this.base_window.update_text(
      value.toString(),
      this.preview_stats_texts[effect_type]
    );
  }
