...
export class DropItemWindow {
  ...
  constructor(game: Phaser.Game, data: GoldenSun) {
    ...
    this.base_window.set_lines_of_text(
    ...
    this.icon_name = this.base_window.set_text_in_position(
      "",
      ICON_NAME_X,
      ICON_NAME_Y
    );
  ...
  set_info() {
    ...
    this.icon = this.base_window.create_at_group(
      INFO_X,
      ICON_Y,
      "items_icons",
  ...
  on_quantity_select() {
    ...
    const controls = [
      ...
      {
        buttons: Button.A,
        on_down: this.on_drop.bind(this),
        sfx: { down: "menu/positive" },
      },
      {
        buttons: Button.B,
        on_down: this.close.bind(this),
  ...
  on_item_select() {
    if (this.item_obj.quantity > 1) {
      ...
      this.item_quant_win.grant_control(
        this.close.bind(this),
        this.on_quantity_select.bind(this)
      );
  ...
  open(
    ...
    this.quantity_to_remove = 0;
    this.item_quant_win =
      this.item_menu.item_options_window.item_quantity_manager_window;
    this.answer_index = 0;
    this.dropped = false;
