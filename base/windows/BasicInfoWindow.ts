...
export class BasicInfoWindow {
  ...
  constructor(game: Phaser.Game) {
    ...
    this.basic_stats_group = this.base_window.define_internal_group(
      BasicInfoWindow.BASIC_STATS_GROUP_KEY
    );
    this.gear_stats_group = this.base_window.define_internal_group(
      BasicInfoWindow.GEAR_STATS_GROUP_KEY
    );
  ...
  set_char_basic_stats(char: MainChar) {
    ...
    this.base_window.update_text(
      this.char.current_exp.toString(),
      this.exp_text
    );
