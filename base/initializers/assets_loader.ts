...
function load_db_files(game) {
  ...
  game.load.json(
    "interactable_objects_db",
    "assets/dbs/interactable_objects_db.json"
  );
  ...
  game.load.json(
    "abilities_cast_db",
    "assets/dbs/abilities_cast_animations/abilities_cast_db.json"
  );
}
...
function load_misc(game) {
  ...
  game.load.image(
    "psynergy_aura",
    "assets/images/psynergies/psynergy_aura.png"
  );
  game.load.atlasJSONHash(
    "menu",
    "assets/images/misc/menu.png",
    "assets/images/misc/menu.json"
  );
  game.load.image(
    "frost_snowflake",
    "assets/images/interactable_objects/snowflake.png"
  );
  ...
  game.load.image(
    "mind_read_arrow",
    "assets/images/psynergies/mind_read_arrow.png"
  );
  game.load.atlasJSONHash(
    "battle_effect_icons",
  ...
  game.load.atlasJSONHash(
    "ranges",
    "assets/images/misc/ranges.png",
    "assets/images/misc/ranges.json"
  );
  game.load.atlasJSONHash(
    "stars",
    "assets/images/misc/stars.png",
    "assets/images/misc/stars.json"
  );
  game.load.atlasJSONHash(
    "emoticons",
    "assets/images/misc/emoticons.png",
    "assets/images/misc/emoticons.json"
  );
  game.load.atlasJSONHash(
    "psynergy_ball",
...
function load_assets(game) {
  ...
  game.load.atlasJSONHash(
    "avatars",
    "assets/images/avatars/avatars.png",
    "assets/images/avatars/avatars.json"
  );
  game.load.atlasJSONHash(
    "battle_shadows",
...
function load_fonts(game) {
  game.load.bitmapFont(
    "gs-bmp-font",
    "assets/font/golden-sun.png",
    "assets/font/golden-sun.fnt"
  );
  game.load.bitmapFont(
    "gs-italic-bmp-font",
  ...
  game.load.bitmapFont(
    "gs-item-bmp-font",
    "assets/font/gs-item-font.png",
    "assets/font/gs-item-font.fnt"
  );
  game.load.bitmapFont(
    "gs-shop-bmp-font",
    "assets/font/gs-shop-font.png",
    "assets/font/gs-shop-font.fnt"
  );
}
